 ...
 * 
 * <p>
 * This class provides a JNA Direct Mapping implementation for accessing the
 * low-latency Direct API (KDMAPI) of the OmniMIDI driver. It is designed to
 * bypass the standard Windows Multimedia API (winmm.dll) to transmit high-load
 * MIDI data (e.g., Black MIDI) with minimal overhead.
 * </p>
 * 
 * <h3>Key Features:</h3>
 * <ul>
 ...
 * <li>Integration with native memory for System Exclusive (Long Data)
 * messages.</li>
 * </ul>
 * 
 * <h3>Usage Notes:</h3>
 * <ul>
 * <li><b>OS Dependency:</b> This class is Windows-only. OmniMIDI must be
 * installed on the host system.</li>
 ...
 * <li><b>Memory Management:</b> When sending SysEx data, ensure the
 * {@link Pointer} refers to a contiguous native memory block, such as one
 * allocated via {@link com.sun.jna.Memory}.</li>
 * </ul>
 * 
 * @see <a href="https://github.com/KeppySoftware/OmniMIDI.git">OmniMIDI GitHub
 *      Repository</a>
...
class KDMAPI {
    ...
    static {
        ...
        // This significantly reduces invocation overhead compared to the Interface
        // Mapping approach.
    ...
    /**
     * Initializes the KDMAPI stream and establishes a connection to the OmniMIDI
     * engine.
     */
    ...
    /**
     * Sends a MIDI short message immediately, bypassing the internal buffer. Ideal
     * for minimizing jitter in time-critical performances.
     */
    ...
    /**
     * Checks if KDMAPI is available (i.e., OmniMIDI is active and accessible) on
     * the current system.
     */
    ...
    /**
     * Provides low-level message transmission compatible with the Windows
     * Multimedia API (modMessage).
     */
